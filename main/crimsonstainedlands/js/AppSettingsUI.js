var A=class{constructor(e){this.aliasesList=null;this.editFormContainer=null;this.addAliasBtn=null;this.app=e,this.initializeUIElements(),this.initializeEventListeners()}initializeUIElements(){this.aliasesList=document.getElementById("aliases-list"),this.editFormContainer=document.getElementById("alias-edit-form-container"),this.addAliasBtn=document.getElementById("add-alias")}initializeEventListeners(){this.addAliasBtn&&this.addAliasBtn.addEventListener("click",()=>{this.showEditForm(null,-1)})}loadAliases(){!this.aliasesList||!this.app.settings.Aliases||(this.aliasesList.innerHTML="",this.editFormContainer&&(this.editFormContainer.innerHTML="",this.editFormContainer.classList.remove("active")),this.app.settings.Aliases.forEach((e,i)=>{if(this.aliasesList===null)return;let t=document.createElement("tr");t.dataset.index=i.toString();let l=document.createElement("td");l.textContent=e.alias,t.appendChild(l);let o=document.createElement("td");o.textContent=e.command,t.appendChild(o);let n=document.createElement("td"),s=document.createElement("button");s.className="client-button",s.textContent="Edit",s.style.marginRight="5px",s.addEventListener("click",()=>{this.showEditForm(e,i)});let a=document.createElement("button");a.className="client-button",a.textContent="Delete",a.addEventListener("click",()=>{this.app.settings.Aliases.splice(i,1),this.app.saveSettings(),this.loadAliases()}),n.appendChild(s),n.appendChild(a),t.appendChild(n),this.aliasesList.appendChild(t)}))}showEditForm(e,i){if(!this.editFormContainer)return;this.editFormContainer.innerHTML="";let t=document.createElement("h4");t.textContent=i===-1?"Add New Alias":"Edit Alias",this.editFormContainer.appendChild(t);let l=document.createElement("div");l.className="form-row";let o=document.createElement("label");o.textContent="Alias:",o.setAttribute("for","edit-alias-input");let n=document.createElement("input");n.type="text",n.id="edit-alias-input",n.value=e?e.alias:"",n.placeholder="e.g., n, sw, l",l.appendChild(o),l.appendChild(n),this.editFormContainer.appendChild(l);let s=document.createElement("div");s.className="form-row";let a=document.createElement("label");a.textContent="Command:",a.setAttribute("for","edit-alias-cmd-input");let r=document.createElement("input");r.type="text",r.id="edit-alias-cmd-input",r.value=e?e.command:"",r.placeholder="e.g., north, southwest, look",s.appendChild(a),s.appendChild(r),this.editFormContainer.appendChild(s);let d=document.createElement("div");d.innerHTML='<small>Tip: Aliases let you type a shorter command that expands to a longer one. For example, use "n" for "north".</small>',d.style.marginTop="5px",d.style.color="#999",this.editFormContainer.appendChild(d);let p=document.createElement("div");p.className="button-row";let h=document.createElement("button");h.className="client-button",h.textContent="Save",h.addEventListener("click",()=>{i===-1?this.app.settings.Aliases.push({alias:n.value,command:r.value}):e&&(e.alias=n.value,e.command=r.value),this.app.saveSettings(),this.loadAliases()});let c=document.createElement("button");c.className="client-button",c.textContent="Cancel",c.style.backgroundColor="#555",c.addEventListener("click",()=>{this.editFormContainer.innerHTML="",this.editFormContainer.classList.remove("active")}),p.appendChild(h),p.appendChild(c),this.editFormContainer.appendChild(p),this.editFormContainer.classList.add("active")}updateUI(){this.loadAliases()}};var P=class{constructor(e){this.triggersList=null;this.editFormContainer=null;this.addTriggerBtn=null;this.app=e,this.initializeUIElements(),this.initializeEventListeners()}initializeUIElements(){this.triggersList=document.getElementById("triggers-list"),this.editFormContainer=document.getElementById("trigger-edit-form-container"),this.addTriggerBtn=document.getElementById("add-trigger")}initializeEventListeners(){this.addTriggerBtn&&this.addTriggerBtn.addEventListener("click",()=>{this.showEditForm(null,-1)})}loadTriggers(){!this.triggersList||!this.app.settings.Triggers||(this.triggersList.innerHTML="",this.editFormContainer&&(this.editFormContainer.innerHTML="",this.editFormContainer.classList.remove("active")),this.app.settings.Triggers.forEach((e,i)=>{if(this.triggersList===null)return;let t=document.createElement("tr");t.dataset.index=i.toString();let l=document.createElement("td");l.textContent=e.match,t.appendChild(l);let o=document.createElement("td");o.textContent=e.type||"regex",t.appendChild(o);let n=document.createElement("td");n.textContent=e.actionType||"text",t.appendChild(n);let s=document.createElement("td");s.textContent=e.actions,t.appendChild(s);let a=document.createElement("td"),r=document.createElement("button");r.className="client-button",r.textContent="Edit",r.style.marginRight="5px",r.addEventListener("click",()=>{this.showEditForm(e,i)});let d=document.createElement("button");d.className="client-button",d.textContent="Delete",d.addEventListener("click",()=>{this.app.settings.Triggers.splice(i,1),this.app.saveSettings(),this.loadTriggers()}),a.appendChild(r),a.appendChild(d),t.appendChild(a),this.triggersList.appendChild(t)}))}showEditForm(e,i){if(!this.editFormContainer)return;this.editFormContainer.innerHTML="";let t=document.createElement("h4");t.textContent=i===-1?"Add New Trigger":"Edit Trigger",this.editFormContainer.appendChild(t);let l=document.createElement("div");l.className="form-row";let o=document.createElement("label");o.textContent="Pattern:",o.setAttribute("for","edit-trigger-pattern");let n=document.createElement("input");n.type="text",n.id="edit-trigger-pattern",n.value=e?e.match:"",n.placeholder="e.g., ^You are hungry\\.$",l.appendChild(o),l.appendChild(n),this.editFormContainer.appendChild(l);let s=document.createElement("div");s.className="form-row";let a=document.createElement("label");a.textContent="Match Type:",a.setAttribute("for","edit-trigger-type");let r=document.createElement("select");r.id="edit-trigger-type",["regex","substring","exact"].forEach(v=>{let g=document.createElement("option");g.value=v,g.textContent=v.charAt(0).toUpperCase()+v.slice(1),(e&&e.type===v||!e&&v==="regex")&&(g.selected=!0),r.appendChild(g)}),s.appendChild(a),s.appendChild(r),this.editFormContainer.appendChild(s);let p=document.createElement("div");p.className="form-row";let h=document.createElement("label");h.textContent="Action Type:",h.setAttribute("for","edit-trigger-action-type");let c=document.createElement("select");c.id="edit-trigger-action-type",["text","javascript"].forEach(v=>{let g=document.createElement("option");g.value=v,g.textContent=v.charAt(0).toUpperCase()+v.slice(1),(e&&e.actionType===v||!e&&v==="text")&&(g.selected=!0),c.appendChild(g)}),p.appendChild(h),p.appendChild(c),this.editFormContainer.appendChild(p);let y=document.createElement("div");y.className="form-row";let I=document.createElement("label");I.textContent="Actions:",I.setAttribute("for","edit-trigger-actions");let f=document.createElement("textarea");f.id="edit-trigger-actions",f.value=e?e.actions:"",f.placeholder="Enter commands or JavaScript code",c.addEventListener("change",()=>{c.value==="text"?f.placeholder="Enter commands to execute when triggered":f.placeholder="Enter JavaScript code to execute when triggered"}),y.appendChild(I),y.appendChild(f),this.editFormContainer.appendChild(y);let m=document.createElement("div");m.innerHTML="<small>Tip: Triggers automatically execute actions when matching text appears in the MUD output.<br>Text actions are sent to the MUD as commands.<br>JavaScript actions are executed in the browser and can use <code>window.mudApp</code> to interact with the client.</small>",m.style.marginTop="5px",m.style.color="#999",this.editFormContainer.appendChild(m);let u=document.createElement("div");u.className="pattern-test-container";let b=document.createElement("h4");b.textContent="Test Pattern",u.appendChild(b);let x=document.createElement("div");x.className="form-row";let L=document.createElement("label");L.textContent="Test Text:",L.setAttribute("for","pattern-test-input");let T=document.createElement("textarea");T.id="pattern-test-input",T.placeholder="Enter text to test against the pattern",T.rows=4,T.style.width="calc(100% - 110px)",T.style.maxWidth="400px",x.appendChild(L),x.appendChild(T),u.appendChild(x);let S=document.createElement("button");S.className="client-button",S.textContent="Test Pattern",S.addEventListener("click",()=>{let v=n.value,g=r.value,V=T.value;if(!v||!V)return;let z=!1;try{z=this.app.matchTrigger(V,g,v);let C=document.getElementById("pattern-test-result");C||(C=document.createElement("div"),C.id="pattern-test-result",C.className="pattern-test-result",u.appendChild(C)),z?(C.textContent="Match found! The trigger would activate.",C.className="pattern-test-result success"):(C.textContent="No match. The trigger would not activate.",C.className="pattern-test-result failure")}catch(C){let w=document.getElementById("pattern-test-result");w||(w=document.createElement("div"),w.id="pattern-test-result",w.className="pattern-test-result",u.appendChild(w)),w.textContent=`Error: ${C instanceof Error?C.message:"Unknown error"}`,w.className="pattern-test-result failure"}}),u.appendChild(S),this.editFormContainer.appendChild(u);let B=document.createElement("div");B.className="button-row",B.style.marginTop="20px";let F=document.createElement("button");F.className="client-button",F.textContent="Save",F.addEventListener("click",()=>{i===-1?this.app.settings.Triggers.push({match:n.value,type:r.value,actions:f.value,actionType:c.value}):e&&(e.match=n.value,e.type=r.value,e.actions=f.value,e.actionType=c.value),this.app.saveSettings(),this.loadTriggers()});let M=document.createElement("button");M.className="client-button",M.textContent="Cancel",M.style.backgroundColor="#555",M.addEventListener("click",()=>{this.editFormContainer&&(this.editFormContainer.innerHTML="",this.editFormContainer.classList.remove("active"))}),B.appendChild(F),B.appendChild(M),this.editFormContainer.appendChild(B),this.editFormContainer.classList.add("active"),e&&e.actionType==="javascript"&&(f.placeholder="Enter JavaScript code to execute when triggered")}updateUI(){this.loadTriggers()}};var N=class{constructor(e){this.keysList=null;this.editFormContainer=null;this.addKeyBtn=null;this.app=e,this.initializeUIElements(),this.initializeEventListeners()}initializeUIElements(){this.keysList=document.getElementById("keys-list"),this.editFormContainer=document.getElementById("edit-form-container"),this.addKeyBtn=document.getElementById("add-key")}initializeEventListeners(){this.addKeyBtn&&this.addKeyBtn.addEventListener("click",()=>{this.showEditForm(null,-1)})}loadKeyBindings(){!this.keysList||!this.app.settings.Keybindings||(this.keysList.innerHTML="",this.editFormContainer&&(this.editFormContainer.innerHTML="",this.editFormContainer.classList.remove("active")),this.app.settings.Keybindings.forEach((e,i)=>{if(this.keysList===null)return;let t=document.createElement("tr");t.dataset.index=i.toString();let l=document.createElement("td");l.textContent=e.key,t.appendChild(l);let o=document.createElement("td");o.textContent=e.commands,t.appendChild(o);let n=document.createElement("td"),s=document.createElement("button");s.className="client-button",s.textContent="Edit",s.style.marginRight="5px",s.addEventListener("click",()=>{this.showEditForm(e,i)});let a=document.createElement("button");a.className="client-button",a.textContent="Delete",a.addEventListener("click",()=>{this.app.settings.Keybindings.splice(i,1),this.app.saveSettings(),this.loadKeyBindings()}),n.appendChild(s),n.appendChild(a),t.appendChild(n),this.keysList.appendChild(t)}))}showEditForm(e,i){if(!this.editFormContainer)return;this.editFormContainer.innerHTML="";let t=document.createElement("h4");t.textContent=i===-1?"Add New Key Binding":"Edit Key Binding",this.editFormContainer.appendChild(t);let l=document.createElement("div");l.className="form-row";let o=document.createElement("label");o.textContent="Key:",o.setAttribute("for","edit-key-input");let n=document.createElement("input");n.type="text",n.id="edit-key-input",n.value=e?e.key:"",n.placeholder="e.g., Numpad8, KeyA, ArrowUp";let s=document.createElement("button");s.className="client-button",s.textContent="Capture Key",s.className="capture-key-btn",s.type="button",l.appendChild(o),l.appendChild(n),l.appendChild(s),this.editFormContainer.appendChild(l);let a=document.createElement("div");a.className="form-row";let r=document.createElement("label");r.textContent="Command:",r.setAttribute("for","edit-cmd-input");let d=document.createElement("input");d.type="text",d.id="edit-cmd-input",d.value=e?e.commands:"",d.placeholder="e.g., north, look, /disconnect",a.appendChild(r),a.appendChild(d),this.editFormContainer.appendChild(a);let p=document.createElement("div");p.innerHTML='<small>Tip: Press "Capture Key" and press any key combination to automatically set the key.</small>',p.style.marginTop="5px",p.style.color="#999",this.editFormContainer.appendChild(p);let h=document.createElement("div");h.className="button-row";let c=document.createElement("button");c.className="client-button",c.textContent="Save",c.addEventListener("click",()=>{i===-1?this.app.settings.Keybindings.push({key:n.value,commands:d.value}):e&&(e.key=n.value,e.commands=d.value),this.app.saveSettings(),this.loadKeyBindings()});let E=document.createElement("button");E.className="client-button",E.textContent="Cancel",E.style.backgroundColor="#555",E.addEventListener("click",()=>{this.editFormContainer&&(this.editFormContainer.innerHTML="",this.editFormContainer.classList.remove("active"))}),h.appendChild(c),h.appendChild(E),this.editFormContainer.appendChild(h),this.editFormContainer.classList.add("active"),s.addEventListener("click",()=>{this.showKeyCaptureDialog(n)})}showKeyCaptureDialog(e){let i=document.createElement("div");i.className="key-capture-overlay";let t=document.createElement("div");t.className="key-capture-dialog";let l=document.createElement("div");l.className="key-capture-content";let o=document.createElement("h3");o.textContent="Waiting for key...";let n=document.createElement("p");n.textContent="Press any key or key combination to capture it.";let s=document.createElement("div");s.className="key-display",s.textContent="Press a key";let a=document.createElement("button");a.className="client-button",a.textContent="Cancel",a.addEventListener("click",()=>{document.body.removeChild(i),document.removeEventListener("keydown",r)}),l.appendChild(o),l.appendChild(n),l.appendChild(s),l.appendChild(a),t.appendChild(l),i.appendChild(t),document.body.appendChild(i),t.focus();let r=d=>{if(d.preventDefault(),d.stopPropagation(),d.key==="Control"||d.key==="Alt"||d.key==="Shift"||d.key==="Meta"||d.code==="ControlLeft"||d.code==="ControlRight"||d.code==="AltLeft"||d.code==="AltRight"||d.code==="ShiftLeft"||d.code==="ShiftRight"){s.textContent="Waiting for a non-modifier key...";return}let p="";d.ctrlKey&&(p+="Ctrl+"),d.altKey&&(p+="Alt+"),d.shiftKey&&(p+="Shift+"),p+=d.code,s.textContent=p,e.value=p,setTimeout(()=>{document.body.removeChild(i),document.removeEventListener("keydown",r)},500)};document.addEventListener("keydown",r)}updateUI(){this.loadKeyBindings()}};var H=class{constructor(e){this.variablesList=null;this.editFormContainer=null;this.addVariableBtn=null;this.app=e,this.initializeUIElements(),this.initializeEventListeners()}initializeUIElements(){this.variablesList=document.getElementById("variables-list"),this.editFormContainer=document.getElementById("variable-edit-form-container"),this.addVariableBtn=document.getElementById("add-variable")}initializeEventListeners(){this.addVariableBtn&&this.addVariableBtn.addEventListener("click",()=>{this.showEditForm(null,-1)})}loadVariables(){!this.variablesList||!this.app.settings.Variables||(this.variablesList.innerHTML="",this.editFormContainer&&(this.editFormContainer.innerHTML="",this.editFormContainer.classList.remove("active")),this.app.settings.Variables.forEach((e,i)=>{if(this.variablesList===null)return;let t=document.createElement("tr");t.dataset.index=i.toString();let l=document.createElement("td");l.textContent=e.name,t.appendChild(l);let o=document.createElement("td");o.textContent=e.type||"string",t.appendChild(o);let n=document.createElement("td");n.textContent=e.value,t.appendChild(n);let s=document.createElement("td"),a=document.createElement("button");a.className="client-button",a.textContent="Edit",a.style.marginRight="5px",a.addEventListener("click",()=>{this.showEditForm(e,i)});let r=document.createElement("button");r.className="client-button",r.textContent="Delete",r.addEventListener("click",()=>{this.app.settings.Variables.splice(i,1),this.app.saveSettings(),this.loadVariables()}),s.appendChild(a),s.appendChild(r),t.appendChild(s),this.variablesList.appendChild(t)}))}showEditForm(e,i){if(!this.editFormContainer)return;this.editFormContainer.innerHTML="";let t=document.createElement("h4");t.textContent=i===-1?"Add New Variable":"Edit Variable",this.editFormContainer.appendChild(t);let l=document.createElement("div");l.className="form-row";let o=document.createElement("label");o.textContent="Name:",o.setAttribute("for","edit-variable-name");let n=document.createElement("input");n.type="text",n.id="edit-variable-name",n.value=e?e.name:"",n.placeholder="e.g., HP, TARGET, LOCATION",l.appendChild(o),l.appendChild(n),this.editFormContainer.appendChild(l);let s=document.createElement("div");s.className="form-row";let a=document.createElement("label");a.textContent="Type:",a.setAttribute("for","edit-variable-type");let r=document.createElement("select");r.id="edit-variable-type",["string","number","boolean"].forEach(m=>{let u=document.createElement("option");u.value=m,u.textContent=m.charAt(0).toUpperCase()+m.slice(1),(e&&e.type===m||!e&&m==="string")&&(u.selected=!0),r.appendChild(u)}),s.appendChild(a),s.appendChild(r),this.editFormContainer.appendChild(s);let p=document.createElement("div");p.className="form-row";let h=document.createElement("label");h.textContent="Value:",h.setAttribute("for","edit-variable-value");let c=document.createElement("input");c.type="text",c.id="edit-variable-value",c.value=e?e.value:"",c.placeholder="Enter variable value",p.appendChild(h),p.appendChild(c),this.editFormContainer.appendChild(p);let E=document.createElement("div");E.innerHTML='<small>Tip: Variables can be used in commands with the $VARNAME syntax. For example, "attack $TARGET" will be replaced with the value of the TARGET variable.</small>',E.style.marginTop="5px",E.style.color="#999",this.editFormContainer.appendChild(E);let y=document.createElement("div");y.className="button-row",y.style.marginTop="20px";let I=document.createElement("button");I.className="client-button",I.textContent="Save",I.addEventListener("click",()=>{let m=n.value.trim().toUpperCase();if(!m){this.app.showNotification("Variable name cannot be empty",!1);return}if(!/^[A-Z0-9_]+$/.test(m)){this.app.showNotification("Variable name can only contain letters, numbers, and underscores",!1);return}if(this.app.settings.Variables.findIndex(L=>L.name.toUpperCase()===m&&(i===-1||this.app.settings.Variables.indexOf(L)!==i))!==-1){this.app.showNotification(`A variable with the name "${m}" already exists`,!1);return}let b=c.value,x=r.value;if(x==="number"){let L=parseFloat(b);if(isNaN(L)){this.app.showNotification("Please enter a valid number",!1);return}b=L.toString()}else x==="boolean"&&(b=b.toLowerCase(),["true","1","yes","y","on"].includes(b)?b="true":b="false");i===-1?this.app.settings.Variables.push({name:m,type:x,value:b}):e&&(e.name=m,e.type=x,e.value=b),this.app.saveSettings(),this.loadVariables()});let f=document.createElement("button");if(f.className="client-button",f.textContent="Cancel",f.style.backgroundColor="#555",f.addEventListener("click",()=>{this.editFormContainer&&(this.editFormContainer.innerHTML="",this.editFormContainer.classList.remove("active"))}),y.appendChild(I),y.appendChild(f),this.editFormContainer.appendChild(y),this.editFormContainer.classList.add("active"),r.addEventListener("change",()=>{let m=r.value;if(m==="boolean"){c.placeholder="Enter true or false";let u=c.value.toLowerCase();["true","false","0","1","yes","no","y","n","on","off"].includes(u)||(c.value="false")}else if(m==="number"){c.placeholder="Enter a number",c.type="number";let u=parseFloat(c.value);isNaN(u)&&(c.value="0")}else c.placeholder="Enter variable value",c.type="text"}),e&&e.type){let m=new Event("change");r.dispatchEvent(m)}}updateUI(){this.loadVariables()}};var U=class{constructor(e){this.profileSelect=null;this.deleteProfileSelect=null;this.quickProfileSelect=null;this.newProfileNameInput=null;this.switchProfileBtn=null;this.createProfileBtn=null;this.deleteProfileBtn=null;this.profileConfirmModal=null;this.profileConfirmClose=null;this.confirmDeleteProfileBtn=null;this.cancelDeleteProfileBtn=null;this.profileToDelete="";this.app=e,this.initializeUIElements(),this.initializeEventListeners()}initializeUIElements(){this.profileSelect=document.getElementById("profile-select"),this.deleteProfileSelect=document.getElementById("delete-profile-select"),this.quickProfileSelect=document.getElementById("quick-profile-select"),this.newProfileNameInput=document.getElementById("new-profile-name"),this.switchProfileBtn=document.getElementById("switch-profile"),this.createProfileBtn=document.getElementById("create-profile"),this.deleteProfileBtn=document.getElementById("delete-profile"),this.profileConfirmModal=document.getElementById("profile-confirm-modal"),this.profileConfirmClose=document.getElementById("profile-confirm-close"),this.confirmDeleteProfileBtn=document.getElementById("confirm-delete-profile"),this.cancelDeleteProfileBtn=document.getElementById("cancel-delete-profile")}initializeEventListeners(){this.switchProfileBtn&&this.profileSelect&&this.switchProfileBtn.addEventListener("click",()=>{let e=this.profileSelect.value;e&&this.app.switchProfile(e)&&(this.app.showNotification(`Profile switched to "${e}"`,!0),this.updateUI())}),this.createProfileBtn&&this.newProfileNameInput&&this.createProfileBtn.addEventListener("click",()=>{let e=this.newProfileNameInput.value.trim();e?this.app.createProfile(e)?(this.app.showNotification(`Profile "${e}" created and activated`,!0),this.newProfileNameInput.value="",this.updateUI()):this.app.showNotification(`A profile named "${e}" already exists`,!1):this.app.showNotification("Please enter a profile name",!1)}),this.deleteProfileBtn&&this.deleteProfileSelect&&this.profileConfirmModal&&this.deleteProfileBtn.addEventListener("click",()=>{this.deleteProfileSelect.value&&(this.profileToDelete=this.deleteProfileSelect.value,this.profileConfirmModal.style.display="block",this.app.setModalOpen(!0))}),this.profileConfirmClose&&this.profileConfirmModal&&this.profileConfirmClose.addEventListener("click",()=>{this.profileConfirmModal.style.display="none",this.profileToDelete="",this.app.setModalOpen(!1)}),this.cancelDeleteProfileBtn&&this.profileConfirmModal&&this.cancelDeleteProfileBtn.addEventListener("click",()=>{this.profileConfirmModal.style.display="none",this.profileToDelete="",this.app.setModalOpen(!1)}),this.confirmDeleteProfileBtn&&this.profileConfirmModal&&this.confirmDeleteProfileBtn.addEventListener("click",()=>{this.profileToDelete&&(this.app.deleteProfile(this.profileToDelete)?this.app.showNotification(`Profile "${this.profileToDelete}" deleted`,!0):this.app.showNotification("Cannot delete the Default profile",!1)),this.profileConfirmModal.style.display="none",this.profileToDelete="",this.app.setModalOpen(!1),this.updateUI()}),this.profileConfirmModal&&this.profileConfirmModal.addEventListener("click",e=>{if(e.target===this.profileConfirmModal){if(this.profileConfirmModal===null)return;this.profileConfirmModal.style.display="none",this.profileToDelete="",this.app.setModalOpen(!1)}}),this.quickProfileSelect&&(this.quickProfileSelect.addEventListener("focus",()=>{this.app.setInteractingWithDropdown(!0)}),this.quickProfileSelect.addEventListener("blur",()=>{this.app.setInteractingWithDropdown(!1)}),this.quickProfileSelect.addEventListener("change",()=>{let e=this.quickProfileSelect.value;if(e&&this.app.switchProfile(e)){this.app.showNotification(`Profile switched to "${e}"`,!0),this.updateUI();let i=document.getElementById("input");i&&i.select()}this.app.setInteractingWithDropdown(!1)})),this.profileSelect&&(this.profileSelect.addEventListener("focus",()=>{this.app.setInteractingWithDropdown(!0)}),this.profileSelect.addEventListener("blur",()=>{this.app.setInteractingWithDropdown(!1)})),this.deleteProfileSelect&&(this.deleteProfileSelect.addEventListener("focus",()=>{this.app.setInteractingWithDropdown(!0)}),this.deleteProfileSelect.addEventListener("blur",()=>{this.app.setInteractingWithDropdown(!1)}))}updateUI(){this.populateProfileDropdowns(),this.updateQuickProfileDropdown()}populateProfileDropdowns(){if(!this.profileSelect||!this.deleteProfileSelect)return;let e=this.app.getProfileNames(),i=this.app.getCurrentProfileName();this.profileSelect.innerHTML="",this.deleteProfileSelect.innerHTML="",e.forEach(t=>{if(this.profileSelect===null)return;let l=document.createElement("option");l.value=t,l.textContent=t,t===i&&(l.selected=!0),this.profileSelect.appendChild(l)}),e.forEach(t=>{if(t!=="Default"){let l=document.createElement("option");l.value=t,l.textContent=t,this.deleteProfileSelect.appendChild(l)}}),e.length<=1&&this.deleteProfileBtn&&this.deleteProfileSelect?(this.deleteProfileBtn.disabled=!0,this.deleteProfileSelect.disabled=!0):this.deleteProfileBtn&&this.deleteProfileSelect&&(this.deleteProfileBtn.disabled=!1,this.deleteProfileSelect.disabled=!1)}updateQuickProfileDropdown(){if(!this.quickProfileSelect)return;this.quickProfileSelect.innerHTML="";let e=this.app.getProfileNames(),i=this.app.getCurrentProfileName();e.forEach(t=>{let l=document.createElement("option");l.value=t,l.textContent=t,t===i&&(l.selected=!0),this.quickProfileSelect.appendChild(l)})}};var D=class{constructor(e){this.settingsModal=null;this.modalTitle=null;this.closeBtn=null;this.cancelBtn=null;this.saveBtn=null;this.menuSettings=null;this.menuAliases=null;this.menuTriggers=null;this.menuKeys=null;this.menuVariables=null;this.sidebarItems=null;this.tabContents=null;this.fontSizeInput=null;this.bgColorInput=null;this.textColorInput=null;this.bgColorValue=null;this.textColorValue=null;this.resetBtn=null;this.app=e,this.createToolbar(),this.createSettingsModal(),this.createImportConfirmModal(),this.createProfileConfirmModal(),this.aliasesUI=new A(e),this.triggersUI=new P(e),this.keyBindingsUI=new N(e),this.variablesUI=new H(e),this.profilesUI=new U(e),this.initializeUIElements(),this.initializeEventListeners(),this.initializeStyles()}createToolbar(){let e=document.createElement("div");e.className="client-menu-bar",e.innerHTML=`
        ...
        `,document.body.appendChild(e)}initializeUIElements(){this.settingsModal=document.getElementById("settings-modal"),this.modalTitle=document.getElementById("modal-title"),this.closeBtn=document.querySelector(".modal-close"),this.cancelBtn=document.getElementById("cancel-settings"),this.saveBtn=document.getElementById("save-settings"),this.menuSettings=document.getElementById("menu-settings"),this.menuAliases=document.getElementById("menu-aliases"),this.menuTriggers=document.getElementById("menu-triggers"),this.menuKeys=document.getElementById("menu-keys"),this.menuVariables=document.getElementById("menu-variables"),this.sidebarItems=document.querySelectorAll(".sidebar-item"),this.tabContents=document.querySelectorAll(".tab-content"),this.fontSizeInput=document.getElementById("font-size"),this.bgColorInput=document.getElementById("bg-color"),this.textColorInput=document.getElementById("text-color"),this.bgColorValue=document.getElementById("bg-color-value"),this.textColorValue=document.getElementById("text-color-value"),this.resetBtn=document.getElementById("reset-settings"),this.updateSettingsUI()}initializeEventListeners(){this.menuSettings&&this.menuSettings.addEventListener("click",()=>this.openModal("settings")),this.menuAliases&&this.menuAliases.addEventListener("click",()=>this.openModal("aliases")),this.menuTriggers&&this.menuTriggers.addEventListener("click",()=>this.openModal("triggers")),this.menuKeys&&this.menuKeys.addEventListener("click",()=>this.openModal("keys")),this.menuVariables&&this.menuVariables.addEventListener("click",()=>this.openModal("variables")),this.closeBtn&&this.closeBtn.addEventListener("click",()=>this.closeModal()),this.cancelBtn&&this.cancelBtn.addEventListener("click",()=>this.closeModal()),this.settingsModal&&this.settingsModal.addEventListener("click",d=>{d.target===this.settingsModal&&this.closeModal()}),this.sidebarItems&&this.sidebarItems.forEach(d=>{d.addEventListener("click",()=>{let p=d.getAttribute("data-tab");p&&this.switchTab(p)})}),this.bgColorInput&&this.bgColorValue&&this.bgColorInput.addEventListener("input",()=>{this.bgColorValue&&(this.bgColorValue.textContent=this.bgColorInput.value)}),this.textColorInput&&this.textColorValue&&this.textColorInput.addEventListener("input",()=>{this.textColorValue&&(this.textColorValue.textContent=this.textColorInput.value)}),this.resetBtn&&this.resetBtn.addEventListener("click",()=>this.resetSettings()),this.saveBtn&&this.saveBtn.addEventListener("click",()=>this.saveSettings());let e=document.getElementById("connect-button"),i=document.getElementById("disconnect-button");e&&e.addEventListener("click",()=>{this.app.sendCommand("/connect"),this.focusInput()}),i&&i.addEventListener("click",()=>{this.app.sendCommand("/disconnect"),this.focusInput()});let t=document.getElementById("export-settings"),l=document.getElementById("import-settings"),o=document.getElementById("settings-file-input"),n=document.getElementById("import-confirm-modal"),s=document.getElementById("import-confirm-close"),a=document.getElementById("confirm-import"),r=document.getElementById("cancel-import");t&&t.addEventListener("click",()=>this.exportSettings()),l&&o&&(l.addEventListener("click",()=>{o.click()}),o.addEventListener("change",d=>{o.files&&o.files.length>0&&n&&(n.style.display="block",this.app.setModalOpen(!0))})),s&&n&&s.addEventListener("click",()=>{n.style.display="none",o&&(o.value=""),this.app.setModalOpen(!1)}),r&&n&&r.addEventListener("click",()=>{n.style.display="none",o&&(o.value=""),this.app.setModalOpen(!1)}),a&&n&&o&&a.addEventListener("click",()=>{this.importSettings(o.files?.[0]),n.style.display="none",this.app.setModalOpen(!1)}),n&&n.addEventListener("click",d=>{d.target===n&&(n.style.display="none",o&&(o.value=""),this.app.setModalOpen(!1))})}initializeStyles(){let e=document.createElement("style");e.textContent=`
            @keyframes fadeOut {
                from { opacity: 1; }
                to { opacity: 0; }
            }
